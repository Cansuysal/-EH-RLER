...
handles.muhf = {'Bölüm Seçiniz...','Bilgisayar','Genel'};
handles.fef = {'Bölüm Seçiniz...','fizik','kimya'};
handles.ibff = {'Bölüm Seçiniz...','maliye' ,'iþletme'};
fakulteler = {'Fakülte Seçiniz...' , 'Muhf' ,'Fef' , 'Ýbff'};
