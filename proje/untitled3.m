...
% Last Modified by GUIDE v2.5 19-Mar-2019 19:03:42
...
resim = imread('logo.jpg');
imshow(resim);
set(handles.popupmenu1,'String',{'Seçiniz','Adana','Mersin'});
...
liste = cellstr(get(hObject,'String'));
sehir = liste{deger};
set(handles.popupmenu2,'Value',1);
switch sehir
    case 'Adana'
        set(handles.popupmenu2,'String',{'Seçiniz','Pozantý','Kozan','Seyhan','Ceyhan'});
    case 'Mersin'
        set(handles.popupmenu2,'String',{'Seçiniz','Silifke','Mezitli'});
    otherwise
        set(handles.popupmenu2,'String',{'Seçiniz'});
end
...
switch ilce
    case 'Kozan'
        resim = imread('kozan.jpg');
    case 'Pozantý'
        resim = imread('pozanti.jpg');
    case 'Silifke'
        resim = imread('silifke.jpg');
    case 'Mezitli'
        resim = imread('kozan.jpg');
    case 'Seyhan'
        resim = imread('seyhan.jpg');
    case 'Ceyhan'
        resim = imread('ceyhan.jpg');
    otherwise
        resim = imread('logo.jpg');
end
imshow(resim);
